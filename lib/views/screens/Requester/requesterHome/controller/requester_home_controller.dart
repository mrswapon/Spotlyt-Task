...
class RequesterHomeController extends GetxController with GetxServiceMixin {
...
handleGetHomeData()async{
  ...
  var headers ={
    ...
    'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2NWZkNDAwMGQ2OGRmMTkzNjA3MDBlMjYiLCJpYXQiOjE3MTEyNzQ0MDEsImV4cCI6MTcxNDc4NTY3NTkyNCwidHlwZSI6ImFjY2VzcyJ9.-gS0qMPw1JjncwGi01YyvrVXsHozemn0wOEX7gvE1Ik'
  };
 try{
