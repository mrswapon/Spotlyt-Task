...
class _MediaServicesScreenState extends State<MediaServicesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () => _serviceController.loading.value
            ? const CustomLoader()
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTextField(
                          ...
                          hintText: "Quantity",
                          helperText:
                              "Minimum Quantity ${attributes.categories![_serviceController.selectedCategoryIndex.value].service![_serviceController.selectedServiceIndex.value].min}, Maximum Quantity ${attributes.categories![_serviceController.selectedCategoryIndex.value].service![_serviceController.selectedServiceIndex.value].max}",
                          onChanged: (value) {
                            _serviceController.calculateTotalPrice(attributes
                                    .categories![_serviceController
                                        .selectedCategoryIndex.value]
                        ...
                        SizedBox(
                          child: DropdownButtonFormField<Interest>(
                            ...
                            items: _serviceController.interestList
